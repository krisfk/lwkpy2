<?php
/**
 * Template Name: Category page (list subcate image only)
...
foreach ($children as $page)
    {
        ...
        <div class="col-lg-<?php echo $idx;?> col-md-12 col-sm-12 col-12 ">
            <?php 
             $redirect_link = get_field('redirect_link',$page->ID);
            
            ?>
            <a class="product-cat-a" href="<?php echo  $redirect_link ? $redirect_link :  get_permalink($page->ID);?>">
